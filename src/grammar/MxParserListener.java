// Generated from C:/UseProjects/myCompiler/src/grammar\MxParser.g4 by ANTLR 4.12.0
 package src.grammar; 
...
public interface MxParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code triExpr}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterTriExpr(MxParser.TriExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code triExpr}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitTriExpr(MxParser.TriExprContext ctx);
	/**
